...
def main():
    ...
    parser.add_argument("--model", type=str, default="breed_expert_mobilenetV3.keras", help="Path to the trained .keras model file.")
    # --------------

    parser.add_argument("--labels", type=str, default="breed_expert_class_indices.json", help="Path to the class indices JSON file.")
