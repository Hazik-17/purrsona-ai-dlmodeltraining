...
DATA_DIR = '../../output'
IMG_SIZE = (224, 224) # EfficientNetV2B0 is optimized for this size
# --- CHANGE 2: Set BATCH_SIZE for EfficientNet ---
BATCH_SIZE = 32      # EfficientNet is efficient, 64 is a good balance.
# ---
EPOCHS_PHASE1 = 20
EPOCHS_PHASE2 = 30
LR_PHASE1 = 1e-3
...
def augment_and_preprocess(image, label):
    ...
    # --- CHANGE 3: Using EfficientNetV2's specific preprocessor ---
...
# === 4. Model Setup ===
# --- CHANGE 4: Use EfficientNetV2B0 as the base model ---
