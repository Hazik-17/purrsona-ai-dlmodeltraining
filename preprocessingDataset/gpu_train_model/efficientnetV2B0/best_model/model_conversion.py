...
MODELS_TO_CONVERT = {  
    ...
    'breed_expert_efficientnetv2b0_v2.keras': 'generalist_breed_model.tflite', # The Generalist 12-Breed Model (93.47% Accuracy)
...
def convert_model_to_tflite(keras_model_path, tflite_model_path):
    ...
    try:
        ...
        # --- CRITICAL FIX: Only use Built-in Ops ---
        # This ensures the model is 100% mobile compatible
        converter.target_spec.supported_ops = [
            tf.lite.OpsSet.TFLITE_BUILTINS
        ]
        
        # OPTIONAL: Fix input shape if you get dynamic shape errors
        # converter.input_shape_dict = {'serving_default_input_1': [1, 224, 224, 3]}
