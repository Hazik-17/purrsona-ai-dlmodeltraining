...
DATA_DIR = '../../output'
IMG_SIZE = (224, 224)
# --- CHANGE: Reduced BATCH_SIZE to improve accuracy ---
BATCH_SIZE = 64  # Was 128. This is the new test.
# ---
EPOCHS_PHASE1 = 20
EPOCHS_PHASE2 = 30
LR_PHASE1 = 1e-3
...
# --- Helper functions for data loading and augmentation ---
def augment_and_preprocess(image, label):
    ...
    image = tf.image.resize(image, [IMG_SIZE[0], IMG_SIZE[1]]) # Resize back
...
model.save('breed_expert_mobilenetV3.keras'); print("\n💾 Model saved as 'breed_expert_mobilenetV3.keras'")
