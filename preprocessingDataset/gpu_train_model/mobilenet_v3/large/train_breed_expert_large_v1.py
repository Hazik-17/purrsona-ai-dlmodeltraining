...
# --- CHANGE 1: Import MobileNetV3Large ---
...
# === 2. Configuration (Same winning hyperparameters) ===
DATA_DIR = '../../output'
IMG_SIZE = (224, 224) 
BATCH_SIZE = 64      # A balanced batch size for this model
EPOCHS_PHASE1 = 20
EPOCHS_PHASE2 = 30
LR_PHASE1 = 1e-3
...
# === 4. Model Setup ===
# --- CHANGE 3: Use MobileNetV3Large as the base model ---
...
plt.savefig('phase_1_training_plot_large.png'); print("\nSaved Phase 1 plot as 'phase_1_training_plot_large.png'")
...
plt.savefig('phase_2_training_plot_large.png'); print("\nSaved Phase 2 plot as 'phase_2_training_plot_large.png'")
...
# --- CHANGE 4: Save with a new name ---
model.save('breed_expert_mobilenetv3_large.keras'); print("\n💾 Model saved as 'breed_expert_mobilenetv3_large.keras'")
# ---
