...
# --- CHANGE 1: Import ResNet50 and its preprocessing ---
...
# === 4. Model Setup ===
# --- CHANGE 4: Use ResNet50 as the base model ---
base_model = ResNet50(
...
print("\n🔁 Starting Phase 1: Train top layers only (ResNet50)")
model.compile(
...
plt.savefig('phase_1_training_plot_resnet50.png'); print("\nSaved Phase 1 plot as 'phase_1_training_plot_resnet50.png'")

# === 6. Phase 2: Fine-tune last 50 layers ===
print(f"\n🔁 Starting Phase 2: Fine-tuning last {UNFREEZE_LAYERS} layers (ResNet50)")
...
plt.savefig('phase_2_training_plot_resnet50.png'); print("\nSaved Phase 2 plot as 'phase_2_training_plot_resnet50.png'")

# === 7. Final Evaluation on Test Set ===
print("\n📊 Final evaluation on test set (ResNet50):")
...
# --- CHANGE 5: Save with a new name ---
model.save('breed_expert_resnet50_v1.keras'); print("\n💾 Model saved as 'breed_expert_resnet50_v1.keras'")
# ---
