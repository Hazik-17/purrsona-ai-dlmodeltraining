...
def main():
    ...
    parser.add_argument("--model", type=str, default="cat_vs_not_cat.keras", help="Path to the trained gatekeeper .keras model.")
    parser.add_argument("--labels", type=str, default="non_cat_class_indices.json", help="Path to the gatekeeper class indices JSON file.")
